...
void mexFunction( int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[] ) 
 { 
    ...
    ocp1.subjectTo((-1.000000E+00+u1) <= 0.000000E+00);
    ocp1.subjectTo((-7.853982E-01+u2) <= 0.000000E+00);
    ocp1.subjectTo((-1.000000E+00-u1) <= 0.000000E+00);
    ocp1.subjectTo(((-7.853982E-01)-u2) <= 0.000000E+00);
    ocp1.subjectTo(AT_END, (-1.000000E+02+x1) <= 0.000000E+00);
    ocp1.subjectTo(AT_END, (-1.000000E+02+x2) <= 0.000000E+00);
    ocp1.subjectTo(AT_END, (-1.000000E+02+x3) <= 0.000000E+00);
    ocp1.subjectTo(AT_END, (-1.000000E+02-x1) <= 0.000000E+00);
    ocp1.subjectTo(AT_END, (-1.000000E+02-x2) <= 0.000000E+00);
    ocp1.subjectTo(AT_END, (-1.000000E+02-x3) <= 0.000000E+00);
